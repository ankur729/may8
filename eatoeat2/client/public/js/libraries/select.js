/*!
 * ui-select
 * http://github.com/qwiglydee/ui-select
 * Version: 0.13.2.q1 - 2015-10-15T02:15:13.629Z
 * License: MIT
 */
...
uis.controller('uiSelectCtrl',
  ...
  ctrl.isDisabled = function(itemScope) {
    ...
    ctrl.select = function(item, skipFocusser, $event) {
      // token selected -- item: token,  search: any,  idx: any
      // object selected -- item: object,  search: any,  idx: any
      // field cleared -- item: undefined,  search: undefined
      // token entered -- item: undefined,  search: token, idx: -1
      if( item && item._uiSelectChoiceDisabled ) return;
      if( item === undefined && ctrl.search && ctrl.tagging.isActivated ) {
        // creating new item
